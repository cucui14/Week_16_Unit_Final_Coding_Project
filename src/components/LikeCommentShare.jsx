const LikeCommentShare = ({ handleShow, post, handleModalPost }) => {
            ...
            <ul className="p-1 d-flex list-unstyled">
                    <li className="pe-2">
                        <button className='border-0 bg-transparent text-primary'>
                            <svg height="24" role="img" width="24" fill="currentColor" className="button-hover">
                            ...
                            <span className="visually-hidden">Like post</span>
                        </button>
                    </li>
                    <li className="pe-2">
